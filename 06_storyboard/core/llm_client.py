...
class LLMConfig:
    ...
    def from_env(cls) -> "LLMConfig":
        ...
        if not api_key:
            raise RuntimeError("06_storyboard text LLM defaults to DeepSeek V4 Pro API. Please set AI_DRAMA_LLM_API_KEY. Optional overrides: AI_DRAMA_LLM_BASE_URL, AI_DRAMA_LLM_MODEL.")
...
class LLMClient:
    """OpenAI-compatible text LLM client for storyboard stages."""
    ...
    def complete_text(self, system_prompt: str, user_prompt: str, trace_label: str = "06_storyboard") -> str:
    ...
    def complete_json(self, system_prompt: str, user_payload: dict[str, Any], repair_callback: Callable[[str, str], dict[str, Any]] | None = None, trace_label: str = "06_storyboard") -> dict[str, Any]:
        guarded_prompt = prompt_guard.apply_json_guard(system_prompt, stage_id="06_storyboard")
