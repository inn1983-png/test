...
class LLMConfig:
    ...
    def from_env(cls) -> "LLMConfig":
        ...
        if not base_url or not model:
            raise RuntimeError(
                "02_script_writer requires a real local LLM. "
        ...
        return cls(
            ...
            temperature=float(os.getenv("AI_DRAMA_LLM_TEMPERATURE", "0.25")),
        )


class LLMClient:
    """Minimal OpenAI-compatible local LLM client for staged script writing."""
