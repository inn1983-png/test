...
class LLMConfig:
    ...
    def from_env(cls) -> "LLMConfig":
        ...
        llm_config_utils.validate_api_key_requirement(base_url, api_key, "02_script_writer")
        return cls(
            base_url=base_url,
            model=model,
            api_key=api_key,
            timeout_sec=llm_config_utils.resolve_llm_timeout(6000),
            temperature=llm_config_utils.resolve_llm_temperature(0.15),
        )
...
class LLMClient:
    ...
    def complete_json(
        ...
        trace_label: str = "02_script_writer",
        module_name: str = "02_script_writer",
    ) -> dict[str, Any]:
