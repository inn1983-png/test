...
stage_runner = import_module("03_character_system.core.stage_runner")
stage_cache = import_module("00_common.stage_cache")

MODULE_NAME = "03_character_system"
DISPLAY_NAME = "角色库系统"
DESCRIPTION = "负责把 01 候选角色与 02 剧本角色使用信息标准化为稳定角色资产库。"
...
def main() -> int:
    try:
        parser = argparse.ArgumentParser(description="03 character system staged runner")
