...
class LLMConfig:
    ...
    def from_env(cls) -> "LLMConfig":
        ...
        llm_config_utils.validate_api_key_requirement(base_url, api_key, "04_scene_system")
        return cls(
            base_url=base_url,
            model=model,
            api_key=api_key,
...
class LLMClient:
    ...
    def complete_json(self, system_prompt: str, user_payload: dict[str, Any], repair_callback: Callable[[str, str], dict[str, Any]] | None = None, trace_label: str = "04_scene_system", module_name: str = "04_scene_system") -> dict[str, Any]:
